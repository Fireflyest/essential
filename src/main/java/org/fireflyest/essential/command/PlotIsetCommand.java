...
public class PlotIsetCommand extends SubCommand {

    private Map<String, Dimension> worldMap;
    private EssentialService service;

    public PlotIsetCommand(EssentialService service, Map<String, Dimension> worldMap) {
    ...
    protected boolean execute(CommandSender sender, String arg1) {
        ...
        domain.setIntimate(dimension.switchPermit(domain.getIntimate(), permit));
        service.updateDomainIntimate(domain.getIntimate(), domain.getName());
