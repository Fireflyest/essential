...
public class PermissionCommand extends SimpleCommand {
    ...
    public PermissionCommand(EssentialPermission permission, ViewGuide guide) {
    ...
    protected boolean execute(@Nonnull CommandSender sender, @Nonnull String arg1, @Nonnull String arg2,
        ...
        if (target == null) {
            ...
            target.sendMessage(Language.PERMISSION_ADD.replace("%permission%", arg2));
            permission.playerAdd("", target, arg2, NumberConversions.toInt(arg3));
